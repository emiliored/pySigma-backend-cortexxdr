...
def test_cortexxdr_integrity_levels_filter_multiple(cortexxdr_backend: CortexXDRBackend):
 ...
 event_sub_type = ENUM.PROCESS_START) and 
 (agent_os_type = ENUM.AGENT_OS_WINDOWS and 
 (((action_process_integrity_level gte 4096 and action_process_integrity_level lt 8192) or (action_process_integrity_level gte 12288 and action_process_integrity_level lt 16384))))''']
...
def test_cortexxdr_generic_translation_mapping(cortexxdr_backend: CortexXDRBackend):
 ...
 actor_process_signature_vendor = "Company Name" and 
 actor_process_integrity_level = "High," and 
 actor_process_cwd = "/current/dir/value," and 
 actor_process_os_id = "1," and 
 causality_actor_process_os_id = "2," and 
 causality_actor_process_command_line = "cmdline_parent /field1=value1," and 
 causality_actor_process_image_path = "explorer.exe," and 
 causality_actor_effective_username = "guest," and 
 causality_actor_process_integrity_level = "Medium," and 
 causality_actor_process_logon_id = "logon_id_text_1," and 
 causality_actor_process_signature_product = "Parent Product Name," and 
...
def test_cortexxdr_process_creation_mapping(cortexxdr_backend : CortexXDRBackend):
 ...
 event_sub_type = ENUM.PROCESS_START) and 
 (action_process_username = "admin," and 
 action_process_image_command_line = "cmdline /field=value," and 
 action_process_image_path = "cmd.exe," and 
 action_process_logon_id = "logon_id_here," and 
 action_process_signature_product = "Product Name," and 
 action_process_signature_vendor = "Company Name," and 
 action_process_integrity_level = "High," and 
 ...
 actor_process_signature_product = "Parent Product Name," and 
 actor_process_signature_vendor = "Parent Company Name," and 
 action_process_image_md5 = "md5md5md5md5," and 
 action_process_image_sha256 = "sha256sha256sha256")''']
...
def test_cortexxdr_image_load_mapping(cortexxdr_backend : CortexXDRBackend):
 ...
 (action_module_path = "foo bar" and 
 action_module_md5 = "asdfasdfasdf" and 
...
def test_cortexxdr_registry_mapping(cortexxdr_backend : CortexXDRBackend):
 ...
 (action_registry_key_name = "foo bar" and 
 (action_registry_value_name = "bar foo" or 
 action_registry_data = "bar foo"))''']
